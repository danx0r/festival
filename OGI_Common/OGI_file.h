...
size_t OGIfread(EST_TVector<OGIbool> &bv, int N, FILE *fp, bool swap=0);
...
int OGIfread(char *ptr, int sz, int N, FILE *fp, bool swap);
int OGIfread(unsigned char *ptr, int sz, int N, FILE *fp, bool swap);
//int OGIfread(OGIbool *ptr, int sz, int N, FILE *fp, bool swap);
